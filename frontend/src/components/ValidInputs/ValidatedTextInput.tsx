...
interface ValidatedTextInputProperties {
    valid: boolean;
    name: string;
    label: string;
...
export const ValidatedTextInput:React.FC<ValidatedTextInputProperties> = ({valid, name, label, changeValue, data, attributes}) => {
