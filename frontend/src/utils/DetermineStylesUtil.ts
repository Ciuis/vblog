import { StyledInputProperties, ValidatedInputState } from "./GlobalInterfaces";

export const determineStyledInputBorder = (props:StyledInputProperties):string => {
...
export const determineLabelColor = (props: StyledInputProperties):string => {
